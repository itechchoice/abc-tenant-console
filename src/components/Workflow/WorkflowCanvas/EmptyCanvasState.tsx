...
import type { WorkflowExecutionSummary } from '@/schemas/workflowRuntimeSchema';
import { STATUS_LABELS } from './config';
import { formatDuration } from './formatters';

interface EmptyCanvasStateProps {
  chatMode: string;
  lastSummary: WorkflowExecutionSummary | null;
  onOpenLastRun: () => void;
}

export function EmptyCanvasState({ chatMode, lastSummary, onOpenLastRun }: EmptyCanvasStateProps) {
  return (
